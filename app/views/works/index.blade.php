	...
	@foreach($works as $key => $work)
        ...
        <td>{{ $work->work_date }}</td>
			...
			<td>
				...
				<a class="btn btn-small btn-success" href="{{ URL::to('works/' . $work->id) }}">Show this work</a>

				<!-- edit this work (uses the edit method found at GET /works/{id}/edit -->
				<a class="btn btn-small btn-info" href="{{ URL::to('works/' . $work->id . '/edit') }}">Edit this work</a>
